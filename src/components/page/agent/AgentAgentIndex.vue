    ...
    <div class="table" v-loading="loading">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-recharge"></i> 推荐代理列表</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
    ...
    export default {
        ...
        methods: {
            ...
            getData(page=1,url='') {
				...
				this.$axios.get(that.ports.agent.agentIndex+"?page="+page+url).then(function(res) {
