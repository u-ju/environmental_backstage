    ...
    <div class="table" v-loading="loading">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-group"></i> 回复列表</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                ...
                <el-input v-model="select_word" placeholder="上级评论id" class="handle-input mr10"></el-input>
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange" id="out-table" :row-class-name="tableRowClassName">
                ...
                <el-table-column prop="buurt_news_id" label="社区文化ID"  width="100" align="center">
                </el-table-column>
                <el-table-column  prop='user_info.nickname' label="昵称" align="center">
                </el-table-column>
                <el-table-column
				    prop="avatar"
...
<script>
    export default {
        ...
        methods: {
            ...
            getData(page=1) {
            	var that =this;
				this.$axios.get(that.ports.buurtNews.replyIndex+"?buurt_news_id="+that.id+"&page="+page).then(function(res) {
...
//              this.tableData.splice(this.idx, 1);
                ...
                that.$axios.post(that.ports.buurtNews.replyDestroy, data)
                .then(function (res) {
