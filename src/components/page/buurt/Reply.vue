    ...
    <div class="table" v-loading="loading">
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange" id="out-table" :row-class-name="tableRowClassName">
                ...
                <el-table-column prop="id" label="新闻ID" sortable width="100" align="center">
                </el-table-column>
...
<script>
    export default {
        ...
        methods: {
            ...
            getData(page=1) {
            	var that =this;
				this.$axios.get(that.ports.buurtN.replyIndex+"?id="+that.id+"&page="+page).then(function(res) {
...
//              this.tableData.splice(this.idx, 1);
                ...
                that.$axios.post(that.ports.buurtN.replyDestroy, data)
                .then(function (res) {
