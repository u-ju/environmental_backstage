	        	...
	        	<el-row  >
		        	...
		        	<div class='itemadd'>
			            ...
			            <el-form-item label="抵扣积分">
			            	<div v-if="item.xiugai">{{item.integral_discount}}</div>
			                <el-input  v-else v-model="form1.integral_discount" ></el-input>
			            </el-form-item>
...
//      			thumb:this.result.skus[i].thumb,
        			...
        			integral_discount:this.result.skus[i].integral_discount,
