    ...
    <div class="table" v-loading="loading">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 直销商品</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table :data="tableData"  class="table" ref="multipleTable" @selection-change="handleSelectionChange" id="out-table">
                ...
                <el-table-column label="操作" width="320" align="center">
                    <template slot-scope="scope">
                    	<router-link :to="{path:'/GoodskuAdd',query: {id: scope.row.spu_id}}">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData(page=1,url='') {
            	var that =this;
				this.$axios.get(that.ports.goods.index+"?page="+page+'&source=exchange'+url).then(function(res) {
