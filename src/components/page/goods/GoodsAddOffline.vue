				...
				<template v-for="(item,i) in wl">
	                ...
	                <el-input v-model="form.nper_price[i]" ></el-input>
						...
						<!--<el-form-item label="缩略图">
							<div @click="dqian(i)">
								<el-upload list-type="picture-card"  class="avatar-uploader" :before-upload="beforeAvatarUpload" :action="uploadurl"  :http-request="upLoad" :limit="1">
...
//				this.form.install_fee.splice(this.deletenum, 1)
			...
			textareablur() {
				var that = this
//				var data={spec_str:encodeURI(that.form.spec_str)}
