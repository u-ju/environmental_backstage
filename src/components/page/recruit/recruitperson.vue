    ...
    <div class="table" v-loading="loading">
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-input class='width200' v-model="search.contact" placeholder="请输入联系电话"></el-input>            	
                <el-input class='width200' v-model="search.email" placeholder="请输入email"></el-input>
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange" id="out-table">
                ...
                <el-table-column  prop='contact' label="电话" align="center" >
                </el-table-column>
                <el-table-column  prop='duty' label="职位" align="center" >
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getData(page=1,url='') {
				...
				this.$axios.get(that.ports.recruit.personIndex+"?page="+page,{params:data}).then(function(res) {
			...
			getsele() {
				...
				this.$axios.get(that.ports.recruit.conf).then(function(res) {
			        that.sele = res.data.result.person.status;
			        
			    })
            },
            search() {
//              this.is_search = true;
				var arr = ["&type=","&cate_id="]
				this.url=''
				for(var i in this.selected){
					this.url=this.url+arr[i]+this.selected[i]
				}
            ...
            saveEdit() {
            	...
            	that.$axios.post(that.ports.recruit.personUpdate, data)
				.then(function (res) {
					console.log(res);
