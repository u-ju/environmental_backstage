    ...
    export default {
        ...
        methods: {
            ...
            getData(page=1,url='') {
				...
				this.$axios.get(that.ports.idle.index+"?page="+page,{params:data}).then(function(res) {
			...
			getsele() {
            	var that =this;
				this.$axios.get(that.ports.idle.conf).then(function(res) {
            ...
            handleEdit(index, row) {
                ...
                this.$axios.get(that.ports.idle.show+this.idx).then(function(res) {
            ...
            saveEdit() {
            	...
            	that.$axios.post(that.ports.idle.update, data)
				.then(function (res) {
					console.log(res);
            ...
            deleteRow(){
                ...
                that.$axios.post(that.ports.idle.destroy, data)
                .then(function (res) {
                	if(res.data.status==200){
                		that.getData();
